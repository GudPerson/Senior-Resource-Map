...
router.get('/', optionalAuth, requirePlatformDirectoryAccess(), requireManagedResourceListAuth(), getHardAssets);
...
router.get('/:id', optionalAuth, requirePlatformDirectoryAccess(), getHardAssetById);
