                    ...
                    <BrowserRouter>
                        <Suspense fallback={<EmbeddedMapLoading />}>
                            <Routes>
                                ...
                                <Route path="/embed/governed-maps/:token" element={GOVERNED_MAPS_UI_ENABLED ? <EmbeddedMapPage mapKind="governed" /> : <GovernedPilotUnavailable capability="Governed Care Maps" />} />
