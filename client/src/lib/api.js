...
export const api = {
    ...
    getResourceClaims: (params = {}) => request('GET', withQuery('/resource-claims', params)),
    getResourceClaimCandidates: (organizationId, resourceType = 'hard', query = '') => request('GET', withQuery('/resource-claims/candidates', {
        organizationId,
        type: resourceType,
        q: query,
    })),
    submitResourceClaim: (body) => request('POST', '/resource-claims', body),
    resubmitResourceClaim: (claimId, body) => request('POST', `/resource-claims/${claimId}/resubmit`, body),
    verifyResourceClaimOwner: (claimId, body) => request('POST', `/resource-claims/${claimId}/verify-owner`, body),
    approveResourcePublication: (claimId, body) => request('POST', `/resource-claims/${claimId}/approve-publication`, body),
    rejectResourceClaim: (claimId, body) => request('POST', `/resource-claims/${claimId}/reject`, body),
    withdrawResourcePermission: (claimId, body) => request('POST', `/resource-claims/${claimId}/withdraw`, body),
    ...
    createPersonalPlace: (body) => request('POST', '/personal-places', body),
    updatePersonalPlace: (placeId, body) => request('PATCH', `/personal-places/${placeId}`, body),
    deletePersonalPlace: (placeId) => request('DELETE', `/personal-places/${placeId}`),
    getPersonalPlaceCategories: () => request('GET', '/personal-places/categories'),
    createPersonalPlaceCategory: (body) => request('POST', '/personal-places/categories', body),
    updatePersonalPlaceCategory: (categoryId, body) => request('PATCH', `/personal-places/categories/${categoryId}`, body),
