...
export const CAREAROUND_BASEMAP_URL = 'https://www.onemap.gov.sg/maps/tiles/Default_HD/{z}/{x}/{y}.png';
export const CAREAROUND_BASEMAP_NATIVE_ZOOM = 19;
export const CAREAROUND_BASEMAP_MAX_ZOOM = CAREAROUND_BASEMAP_NATIVE_ZOOM - 1;
