...
export default function AdminPage() {
    ...
    async function loadAll() {
        setLoading(true);
        try {
            const [res, usr, subCats] = await Promise.all([api.getResources(), api.getUsers(), api.getSubCategories()]);
            setResources(res);
            setUsers(usr);
        ...
        <div className="p-6 lg:p-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
                {[
                    ...
                    { label: 'Admins', val: users.filter(u => u.role === 'admin').length, color: 'bg-red-50 text-red-700', icon: Shield },
