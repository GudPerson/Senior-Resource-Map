...
function MapLegend() {
    return (
        <div className="mt-4 flex items-center justify-between rounded-xl border border-slate-100 bg-slate-50/50 px-4 py-2.5 text-[12px] font-bold text-slate-600 shadow-sm backdrop-blur-sm isolate">
