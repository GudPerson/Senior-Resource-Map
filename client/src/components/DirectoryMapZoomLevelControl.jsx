...
export default function DirectoryMapZoomLevelControl({
    ...
    useEffect(() => {
        ...
        const counter = zoomControlContainer
            ? L.DomUtil.create(
                'div',
                'carearound-map-zoom-level flex h-6 min-w-[30px] select-none items-center justify-center rounded-t-[4px] border-b border-slate-300 bg-white text-[10px] font-extrabold leading-none text-slate-500',
            )
            : null;
